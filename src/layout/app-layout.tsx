...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiShoppingBag } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'customer-service-representative', 'store-manager'];
  ...
  const { data, error, isLoading } = useSWR<RetailerInterface[]>(
    ...
    () => getRetailers({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
